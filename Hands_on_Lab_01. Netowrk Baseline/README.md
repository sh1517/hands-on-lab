...
> |Region|VPC_Name|CIDR|Subnet_Name|CIDR|Routing_Table_Name|Gateway_Name|
> |:---:|:---:|:---:|:---:|:---:|:---:|:---:|
> |ap-northeast-2|lab-edu-vpc-ap-01|10.0.0.0/16 |lab-edu-sub-pub-01|10.0.0.0/24 |lab-edu-rtb-pub    |lab-edu-igw-ap|
> |   |   |                                     |lab-edu-sub-pub-02|10.0.1.0/24 |lab-edu-rtb-pub    |lab-edu-igw-ap|
> |   |   |                                     |lab-edu-sub-pri-01|10.0.40.0/24|lab-edu-rtb-pri-01 |lab-edu-natgw-01|
...
- **Subnet 리소스 탭 → lab-edu-sub-pub-01 선택 → '작업' 버튼 클릭 → '서브넷 설정 편지' 버튼 클릭 → 퍼블릭 IPv4 주소 지정 할당 활성화 → 저장**
...
- **Internet Gateway 세부 정보 화면 → 우측 상단 '작업' 버튼 클릭 → 'VPC에 연결' 버튼 클릭' → 사용 가능한 VPC 선택 (lab-edu-vpc-ap-01) → '인터넷 게이트웨이 연결' 버튼 클릭'**
...
**※ 위 과정을 동일하게 한 번 더 진행하면서 lab-edu-rtb-pri-02에 lab-edu-sub-pri-02 연결**
